...
const img1 =
  ...
  "assets/images/crime-spot/crimespot_1.png";
const img2 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/crime-spot/crimespot_2.png";
const img3 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/crime-spot/crimespot_3.png";

const pdf1 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/crime-spot/kelly_gorr_web_integration.pdf";
      ...
      slideshow: {
        ...
        slides: [
          ...
          },
          {
            img: img3,
            caption:
              "Map filtered by 'assualt' and 'homicide', map with selection, and news details",
          },
        ],
      },
    },
