...
const img1 =
  import.meta.env.VITE_IMAGE_URL_SRC + "assets/images/focus-orderer/1.jpg";
const img5 =
  import.meta.env.VITE_IMAGE_URL_SRC + "assets/images/focus-orderer/3.jpg";
const img7 =
  import.meta.env.VITE_IMAGE_URL_SRC + "assets/images/focus-orderer/4.jpg";
const img4 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/video1thumb2.jpg";
const img6 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/video2thumb2.jpg";
const img8 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/v2/v2-1.jpg";
const img9 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/v2/v2-2.jpg";
const img10 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/v2/v2-3.jpg";
const img11 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/v2/v2-4.jpg";
const video1 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/v2/v2-video.mp4";
const video2 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/focus-orderer/sizedvid2.mp4";
      ...
      attachments: [
        {
          ...
          file: {
            type: FileType.Link,
            source:
              "https://twitter.com/MicrosoftDesign/status/1304072149334925314",
          },
        },
        {
