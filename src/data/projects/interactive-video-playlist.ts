...
const video2 =
  import.meta.env.VITE_IMAGE_URL_SRC + "assets/videos/slipknotXboxI.mp4";

const img1 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer5.png";
const img2 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer8.png";
const img3 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer1.png";
const img4 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer6.png";
const img5 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer3.png";
const img6 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer4.png";
const img7 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer7.png";
const img8 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer14.png";
const img9 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer11.png";
const img10 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer15.png";
const img11 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/summer12.png";

const img12 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/itv6.jpg";
const img13 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/itv3.jpg";
const img14 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/itv4.jpg";
const img15 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/interactive-video-playlist/itv5.jpg";
      ...
      slideshow: {
        ...
        slides: [
          ...
          },
          {
            img: img4,
            caption:
              "Buttons can link to full length videos or purchasable content",
          },
          {
            img: img5,
          ...
          },
          {
            img: img8,
            caption:
              "A fallback quiz can be inserted if the polling database is unavailable",
          },
          {
            img: img9,
          },
