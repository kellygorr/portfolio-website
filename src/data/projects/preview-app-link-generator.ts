...
const img1 =
  ...
  "assets/images/preview-app-link-generator/previewApp1.jpg";
const img2 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/preview-app-link-generator/previewApp4.jpg";
const img3 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/preview-app-link-generator/previewApp6.jpg";
const img4 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/preview-app-link-generator/previewApp3.jpg";
const img5 =
  import.meta.env.VITE_IMAGE_URL_SRC +
  "assets/images/preview-app-link-generator/previewApp2.jpg";
      ...
      slideshow: {
        ...
        slides: [
          ...
          },
          {
            img: img2,
            caption:
              "Error messages are included to help users include all the required information",
          },
          {
            img: img3,
